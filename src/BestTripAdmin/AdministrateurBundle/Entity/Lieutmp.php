...
class Lieutmp
{
     ...
     * Set idRec
     *
     * @param \BestTripAdmin\AdministrateurBundle\Entity\Recommandation $idRec
     * @return Lieutmp
     */
    public function setIdRec(\BestTripAdmin\AdministrateurBundle\Entity\Recommandation $idRec = null)
    {
        $this->idRec = $idRec;
