...
class Parrainage
{
    /**
     * @var integer
     * @Assert\NotBlank(message = "Veuillez entrer un prix pour votre parrainage !")
    ...
    /**
     * @var string
     * @Assert\NotBlank(message = "Veuillez entrer uune description pour votre parrainage !")
    ...
    /**
     * @var integer
     * @Assert\NotBlank(message = "Veuillez entrer un nommbre de participant pour votre parrainage !")
    ...
    /**
     * @var string
     * @Assert\NotBlank(message = "Veuillez entrer un titre pour votre parrainage !")
