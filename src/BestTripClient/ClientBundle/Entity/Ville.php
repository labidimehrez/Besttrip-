...
class Ville
{
     ...
     * @return Ville
     */
    public function addIdItineraire(\BestTripClient\ClientBundle\Entity\Itineraire $idItineraire)
    {
     ...
     * @param \BestTripClient\ClientBundle\Entity\Itineraire $idItineraire
     */
    public function removeIdItineraire(\BestTripClient\ClientBundle\Entity\Itineraire $idItineraire)
    {
     ...
     * Add idOffrep
     *
     * @param \BestTripClient\ClientBundle\Entity\OffreProfessionnelle $idOffrep
     * @return Ville
     */
    public function addIdOffrep(\BestTripClient\ClientBundle\Entity\OffreProfessionnelle $idOffrep)
    {
     ...
     * @param \BestTripClient\ClientBundle\Entity\OffreProfessionnelle $idOffrep
     */
    public function removeIdOffrep(\BestTripClient\ClientBundle\Entity\OffreProfessionnelle $idOffrep)
    {
